  ...
  return (
    <main className="min-h-screen pb-[88px] bg-[#F4F4F4]">
      ...
      <header className="bg-white">
        {/* 타이틀 + 프로필 아이콘 */}
        <div className="mx-auto w-full max-w-[420px] px-5 pt-4 pb-3 flex items-center justify-between">
          <h1 className="text-[20px] font-bold text-gray-800">D-tour</h1>
          <Image src="/profile.svg" alt="프로필" width={24} height={24} />
        </div>

        {/* 검색 바 */}
        <div className="mx-auto w-full max-w-[420px] px-5 pb-4">
          <div className="flex items-center gap-2 border-b border-gray-300 focus-within:border-gray-500 transition-colors">
            <input
              type="text"
              placeholder="검색어를 입력해주세요"
              className="w-full bg-transparent outline-none border-none placeholder:text-gray-400 text-[14px] py-2"
            />
            {/* 검색 아이콘 (svg) */}
            <svg
              width="18"
