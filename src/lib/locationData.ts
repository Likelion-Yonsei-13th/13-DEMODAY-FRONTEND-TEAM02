...
export const STATE_CITIES: Record<string, string[]> = {
  ...
  "부산광역시": [
    ...
    "수영구", "사하구", "금정구", "연제구", "남해구", "기장군"
  ],
  "대구광역시": [
    "중구", "동구", "서구", "남구", "북구", "수성구", "달서구", "달성군"
  ],
  "인천광역시": [
    "중구", "동구", "남구", "남동구", "부평구", "계양구", "서구", "강화군", "옹진군"
  ],
  "광주광역시": [
    "동구", "서구", "남구", "북구", "광산구"
  ],
  ...
  "경기도": [
    "수원시", "성남시", "의정부시", "하남시", "고양시", "동두천시", "과천시", "구리시",
    "남양주시", "오산시", "시흥시", "군포시", "의왕시", "광명시", "평택시", "안산시",
    "이천시", "여주시", "안성시", "파주시", "이산시", "김포시", "화성시", "광주시",
    "포천시", "연천군", "가평군", "양평군"
  ],
  "강원도": [
  ...
  "경상북도": [
    "포항시", "경주시", "김천시", "안동시", "구미시", "영천시", "상주시", "문경시",
    "경산시", "군위군", "의성군", "청송군", "영양군", "영덕군", "청도군", "고령군",
    "성주군", "칠곡군", "예천군", "봉화군", "울진군", "울릉군"
  ],
  "경상남도": [
    "창원시", "마산시", "진해시", "통영시", "사천시", "김해시", "밀양시", "거제시",
    "남해군", "하동군", "산청군", "진주시", "함양군", "거창군", "합천군"
  ],
  "제주특별자치도": [
    "제주시", "서귀포시"
  ],
